class CreateOauthConsumerTokens < ActiveRecord::Migration
  def self.up
    ...
    add_column :google_calendars, :user_id, :integer
  ...
  def self.down
    ...
    add_column :google_calendars, :encrypted_login, :string
    add_column :google_calendars, :encrypted_password, :string
    remove_column :google_calendars, :user_id
  end
